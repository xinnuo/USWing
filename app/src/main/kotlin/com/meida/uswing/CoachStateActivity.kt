...
class CoachStateActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        EventBus.getDefault().register(this@CoachStateActivity)
    ...
    override fun finish() {
        EventBus.getDefault().unregister(this@CoachStateActivity)
        super.finish()
    }
