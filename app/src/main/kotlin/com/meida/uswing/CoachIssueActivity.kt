...
class CoachIssueActivity : BaseActivity() {

    private var selectList = ArrayList<LocalMedia>()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_coach_issue)
        init_title("添加魔频")
                ...
                .register<LocalMedia>(R.layout.item_issue_grid) { data, injector ->
                    ...
                    injector.text(R.id.item_issue_duration, DateUtils.timeParse(data.duration))
                        ...
                        .clicked(R.id.item_issue_img) {
                            when (data.mimeType) {
                                PictureMimeType.ofAll() -> slectVideo()
                                PictureMimeType.ofVideo() ->
                                    PictureSelector.create(this@CoachIssueActivity)
    ...
    override fun doClick(v: View) {
        ...
        when (v.id) {
            R.id.issue_done -> {
                ...
                OkGo.post<String>(BaseHttp.add_voide_coach)
                    .tag(this@CoachIssueActivity)
                    .isMultipart(true)
                    .headers("token", getString("token"))
                    .params("videoIntroduction", issue_content.text.trimString())
                    ...
                    .execute(object : StringDialogCallback(baseContext) {
                        ...
                        override fun onSuccessResponse(response: Response<String>, msg: String, msgCode: String) {
                            ...
                            toast(msg)
                            ActivityStack.screenManager.popActivities(this@CoachIssueActivity::class.java)
                        }
