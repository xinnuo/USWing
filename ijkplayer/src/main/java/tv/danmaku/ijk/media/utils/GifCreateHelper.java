...
import tv.danmaku.ijk.media.listener.IVideoGifSaveListener;
...
public class GifCreateHelper {
    ...
    private IVideoGifSaveListener mVideoGifSaveListener;
    ...
    public GifCreateHelper(StandardVideoPlayer standardVideoPlayer, IVideoGifSaveListener videoGifSaveListener) {
        this(standardVideoPlayer, videoGifSaveListener, 0, 1, 5, 50);
    }
    ...
    private void startSaveBitmap() {
        ...
        File file = new File(mTmpPath, "IJK-TMP-FRAME" + System.currentTimeMillis() + ".tmp");
        mPlayer.saveFrame(file, new IVideoShotSaveListener() {
            @Override
    ...
    public void createGif(File file, List<String> pics, int delay, int inSampleSize, int scaleSize,
                          final IVideoGifSaveListener videoGifSaveListener) {
