 ...
 * SurfaceView
 */
public class SurfaceView extends android.view.SurfaceView implements SurfaceHolder.Callback2, IRenderView, MeasureHelper.MeasureFormVideoParamsListener {
     ...
     * 添加播放的view
     */
    public static SurfaceView addSurfaceView(Context context,
        ...
        SurfaceView showSurfaceView = new SurfaceView(context);
