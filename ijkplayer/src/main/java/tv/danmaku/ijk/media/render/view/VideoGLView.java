...
import tv.danmaku.ijk.media.render.glrender.VideoGLViewSimpleRender;
import tv.danmaku.ijk.media.render.view.listener.GLSurfaceListener;
import tv.danmaku.ijk.media.render.view.listener.ISurfaceListener;
import tv.danmaku.ijk.media.render.view.listener.IVideoGLRenderErrorListener;
...
public class VideoGLView extends GLSurfaceView implements GLSurfaceListener, IRenderView, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    public void setVideoGLRenderErrorListener(IVideoGLRenderErrorListener videoGLRenderErrorListener) {
    ...
    public static VideoGLView addGLView(final Context context, final ViewGroup textureViewContainer, final int rotate,
        ...
        videoGLView.setVideoGLRenderErrorListener(new IVideoGLRenderErrorListener() {
        ...
        if (transform != null && transform.length == 16) videoGLView.setMVPMatrix(transform);
