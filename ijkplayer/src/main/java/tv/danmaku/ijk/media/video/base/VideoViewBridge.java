...
public interface VideoViewBridge {
    ...
    IMediaPlayerListener listener();

    IMediaPlayerListener lastListener();

    void setListener(IMediaPlayerListener listener);

    void setLastListener(IMediaPlayerListener lastListener);
