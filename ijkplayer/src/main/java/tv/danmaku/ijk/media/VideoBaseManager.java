...
import tv.danmaku.ijk.media.cache.CacheFactory;
 ...
 * 基类管理器
 */
public abstract class VideoBaseManager implements
    ...
    protected WeakReference<IMediaPlayerListener> listener;

    protected WeakReference<IMediaPlayerListener> lastListener;
    ...
    @Override
    public IMediaPlayerListener listener() {
        if (listener == null)
            return null;
        return listener.get();
    }
    ...
    @Override
    public IMediaPlayerListener lastListener() {
    ...
    @Override
    public void setLastListener(IMediaPlayerListener lastListener) {
        if (lastListener == null)
