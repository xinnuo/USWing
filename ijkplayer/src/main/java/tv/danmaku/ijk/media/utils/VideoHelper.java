...
public class VideoHelper {
    ...
    public VideoHelper(Context context, StandardVideoPlayer player) {
        ...
        this.mWindowViewContainer = (CommonUtil.scanForActivity(context)).findViewById(Window.ID_ANDROID_CONTENT);
    }
    ...
    private void resolveToFull() {
        ...
        //设置旋转
        mOrientationUtils = new OrientationUtils((Activity) mContext, mVideoPlayer);
    ...
    public void showSmallVideo(Point size, final boolean actionBar, final boolean statusBar) {
        if (mVideoPlayer.getCurrentState() == mVideoPlayer.CURRENT_STATE_PLAYING) {
    ...
    public static class VideoHelperBuilder extends VideoOptionBuilder {
        ...
        public IVideoProgressListener getVideoProgressListener() {
