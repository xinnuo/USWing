...
public abstract class VideoGLViewBaseRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    protected IVideoGLRenderErrorListener mVideoGLRenderErrorListener;
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (mGLSurfaceListener != null) {
                    mGLSurfaceListener.onSurfaceAvailable(surface);
                }
            }
        });
    }
    ...
    public void setSurfaceListener(GLSurfaceListener onSurfaceListener) {
        this.mGLSurfaceListener = onSurfaceListener;
    }
