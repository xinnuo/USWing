 ...
 * 详情模式播放页面基础类
 */
public abstract class BaseActivityDetail<T extends BaseVideoPlayer> extends AppCompatActivity implements IVideoAllCallBack {
    ...
    public void initVideo() {
        //外部辅助的旋转，帮助全屏
        orientationUtils = new OrientationUtils(this, getVideoPlayer());
        //初始化不打开外部的旋转
    ...
    public void showFull() {
        ...
        getVideoPlayer().startWindowFullscreen(BaseActivityDetail.this, hideActionBarWhenFull(), hideStatusBarWhenFull());
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        //如果旋转了就全屏
        if (isPlay && !isPause) {
            getVideoPlayer().onConfigurationChanged(this, newConfig, orientationUtils, hideActionBarWhenFull(), hideStatusBarWhenFull());
        }
    }
     ...
     * 配置播放器
     */
    public abstract VideoOptionBuilder getVideoOptionBuilder();
