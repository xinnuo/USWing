...
import tv.danmaku.ijk.media.listener.IVideoAllCallBack;
import tv.danmaku.ijk.media.utils.CommonUtil;
import tv.danmaku.ijk.media.utils.Debuger;
import tv.danmaku.ijk.media.utils.NetInfoModule;

import static tv.danmaku.ijk.media.utils.CommonUtil.getTextSpeed;

/**
 * 视频回调与状态处理等相关层
 */
public abstract class VideoView extends TextureRenderView implements IMediaPlayerListener {
    ...
    //视频回调
    protected IVideoAllCallBack mVideoAllCallBack;
    ...
    protected void init(Context context) {
        ...
        this.mContext = getActivityContext() != null ? this.mContext = getActivityContext() : context;
    ...
    public void onAutoCompletion() {
        ...
        if (!mIfCurrentIsFullscreen) getVideoManager().setLastListener(null);
    ...
    public void startAfterPrepared() {
        ...
        try {
            if (getVideoManager() != null) getVideoManager().start();
     ...
     * 设置播放过程中的回调
     */
    public void setVideoAllCallBack(IVideoAllCallBack mVideoAllCallBack) {
    ...
    public void setMapHeadData(Map<String, String> headData) {
        if (headData != null) this.mMapHeadData = headData;
    }
