package tv.danmaku.ijk.media.builder;
...
import tv.danmaku.ijk.media.listener.ILockClickListener;
...
public class VideoOptionBuilder {
    ...
    //点击锁屏的回调
    protected ILockClickListener mLockClickListener;
    ...
    //进度回调
    protected IVideoProgressListener mVideoProgressListener;
     ...
     */
    public VideoOptionBuilder setVideoAllCallBack(IVideoAllCallBack mVideoAllCallBack) {
     ...
     * 进度回调
     */
    public VideoOptionBuilder setVideoProgressListener(IVideoProgressListener videoProgressListener) {
     ...
     * 锁屏点击
     */
    public VideoOptionBuilder setLockClickListener(ILockClickListener lockClickListener) {
